            ...
            },
            {
                ...
                Cell: ({ cell }) => (
                    <div className="">
                        ...
                        <button onClick={handleAllow} data-action="deactivate" data-id={cell.row.original.id} className="px-2 py-1 m-1 hover:bg-red-300 rounded-full bg-red-200">Revoke</button>
                    </div>
                  )
            },
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            val = await axios.get("/sanctum/csrf-cookie").then((response) => {
                axios
                    .get(`api/user/index?page=${tableRefreshed}`, {
