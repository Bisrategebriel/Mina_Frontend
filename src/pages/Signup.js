                ...
                <div className="col-span-12 xl:col-span-8 xl:col-start-3 row-start-2 row-span-4 p-12 rounded-lg relative">
                    ...
                    <div className="grid grid-cols-12 px-6 xl:px-24 relative z-20 gap-4">
                        ...
                        <form className="col-span-12 grid-cols-12 grid gap-4">
                            {/* signup form */}
                            <div id="personalInfo" className="col-span-12 grid-cols-12 grid gap-4 hidden">
                                <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                    <label className="text-sm text-start" htmlFor="first_name">First Name</label>
                                    <input type="text" name="first_name" id="first_name" placeholder="First Name" className="p-3 bg-gray-200 rounded-lg" required />
                                </div>
                                <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                    <label className="text-sm text-start" htmlFor="first_name">Last Name</label>
                                    <input type="text" name="last_name" id="last_name" placeholder="Last Name" className="p-3 bg-gray-200 rounded-lg" required />
                                </div>
                                <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                ...
                                <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                    <label className="text-sm text-start" htmlFor="phone_number">Phone Number</label>
                                    <input type="text" name="phone_number" id="phone_number" placeholder="Phone Number" className="p-3 bg-gray-200 rounded-lg" required />
                                </div>
                                <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                ...
                                <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                    <label className="text-sm text-start" htmlFor="confirm_password">Confirm Password</label>
                                    <input type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password" className="p-3 bg-gray-200 rounded-lg" required />
                                </div>
                            ...
                            <div className="col-span-12 grid-cols-12 grid gap-4 hidden">
                                ...
                                <div className="col-span-12 2xl:col-span-6 p-3 border border-1 border-mina-blue-light rounded-lg flex items-center space-x-2 space-between">
                                    ...
                                    <div className="flex flex-col items-start">
                                        ...
                                        <p className="text-start"> <span className="text-sm font-bold">  Account Name: </span>Mina Entertainment</p>
                                        <p className="text-start"><span className="text-sm font-bold">Account Number: </span>1000123456789</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-span-12">
                                    <button className="bg-mina-orange-light py-2 px-4 text-lg rounded-lg text-white font-bold w-full">Confirm Payment</button>
                                </div>
                            </div>
                            ...
                            <div className="col-span-12 grid gap-4 grid-cols-12">
                                <div className="col-span-12 md:col-span-4 flex flex-row md:flex-col items-center justify-around md:justify-center space-x-2 space-y-0 md:space-x-0 md:space-y-4">
                                    <div className="">
                                        <input type="radio" name="bank" id="cbe" className="hidden peer" />
                                        <label className="bg-white p-2 peer-checked:bg-mina-blue-light w-16 md:w-24 h-16 md:h-24 flex" for="cbe">
                                            <img src={cbe} alt="" srcSet="" className="w-24 auto"/>
                                        </label>
                                    </div>

                                    <div>
                                        <input type="radio" name="bank" id="abyssinia" className="hidden peer" />
                                        <label className="bg-white p-2 peer-checked:bg-mina-blue-light w-16 md:w-24 h-16 md:h-24 flex" for="abyssinia">
                                            <img src={abyssinia} alt="" srcSet="" />
                                        </label>
                                    </div>
                                    
                                    <div>
                                        <input type="radio" name="bank" id="awash" className="hidden peer" />
                                        <label className="bg-white p-2 peer-checked:bg-mina-blue-light w-16 md:w-24 h-16 md:h-24 flex" for="awash">
                                            <img src={awash} alt="" srcSet="" />
                                        </label>
                                    </div>

                                    <div>
                                        <input type="radio" name="bank" id="dashen" className="hidden peer" />
                                        <label className="bg-white p-2 peer-checked:bg-mina-blue-light w-16 md:w-24 h-16 md:h-24 flex" for="dashen">
                                            <img src={dashen} alt="" srcSet="" />
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="col-span-12 md:col-span-8 grid-cols-12 space-y-4">
                                    <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                        <label className="text-sm text-start" htmlFor="first_name">Deposited By</label>
                                        <input type="text" name="full_name" id="full_name" placeholder="Full Name" className="p-3 bg-gray-200 rounded-lg" required />
                                    </div>
                                    <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                        <label className="text-sm text-start" htmlFor="transaction_number">Transaction Number</label>
                                        <input type="text" name="transaction_number" id="transaction_number" placeholder="Transaction Reference Number" className="p-3 bg-gray-200 rounded-lg" required />
                                    </div>
                                    <div className="col-span-12 md:col-span-6 flex flex-col space-y-2 justify-start">
                                        <label className="text-sm text-start" htmlFor="payment_date">Deposited At</label>
                                        <input type="date" name="payment_date" id="payment_date" placeholder="Payment Date" className="p-3 bg-gray-200 rounded-lg" required />
                                    </div>
                                    ...
                                    <div className="col-span-12 flex justify-start space-x-2">
                                        ...
                                        <label htmlFor="terms_agreement">
                                            <p className="text-start text-xs">By Signing up, you agree to our Terms and Privacy Policy</p>
                                        </label>
                                    </div>
                                    <div className="col-span-12">
                                        <button className="bg-mina-orange-light py-2 px-4 text-lg rounded-lg text-white font-bold w-full">Confirm Payment</button>
                        ...
                        <div className="col-span-12 flex justify-center">
                            Already have an account? <Link className="text-mina-blue-dark font-bold" to="/signin" > Login </Link>
                        </div>
                    </div>
